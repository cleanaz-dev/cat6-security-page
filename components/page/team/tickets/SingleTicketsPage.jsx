...
export default function SingleTicketsPage({ ticket, notes }) {
  if (!ticket) return <p className="text-muted-foreground">No ticket data provided.</p>;
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-xl flex gap-2 items-center"><Construction className="text-primary"/>   <span className="capitalize">{ticket.subject}</span></CardTitle>
