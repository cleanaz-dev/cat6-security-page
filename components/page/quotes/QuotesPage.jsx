    ...
    <div className="container px-2 md:px-0 mx-auto py-4 md:py-8">
      ...
      {quotes.length === 0 ? (
        <div className="text-center py-8 md:py-12">
          <h3 className="text-base md:text-lg font-medium">No quotes available</h3>
        ...
        <div className="grid grid-cols-1 gap-3 md:gap-6">
          {quotes.map((quote, index) => (
            <Card key={index} className="hover:shadow-lg transition-shadow border border-muted p-2 md:p-4 rounded-lg">
              {/* Mobile-first layout */}
                    ...
                    <AccordionContent>
                      {quote.items?.length > 0 && (
                        <div className="mt-2 md:mt-4">
                          <h3 className="font-medium text-sm md:text-base">Items</h3>
                      ...
                      <div className="mt-2 md:mt-4 flex justify-between text-xs md:text-sm">
